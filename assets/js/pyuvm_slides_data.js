(function () {
  ...
  const slides = [
    ...
    t.hierarchySlide({
      index: 14, tag: 'Hierarchy', title: 'The Structure of <span class="tone-blue">PyUVM</span>',
