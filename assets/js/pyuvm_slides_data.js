(function () {
  ...
  const slides = [
    ...
    t.phaseExampleSlide({
      index: 16, tag: 'Phases', title: 'What Are <span class="tone-cyan">Phases</span>? With Example',
    ...
    t.conceptSplitSlide({
      index: 20, tag: 'Interface Layer', title: 'What is <span class="tone-cyan">cocotb</span>?',
