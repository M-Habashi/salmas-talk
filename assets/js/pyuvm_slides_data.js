(function () {
  ...
  const slides = [
    ...
    t.agendaSlide({
      ...
      items: ['What is UVM?', 'UVM Testbench Architecture', 'UVM Hierarchy', 'The Problem with Traditional UVM', 'What is PyUVM?', 'Advantages of PyUVM over Traditional UVM', 'UVM Testbench Architecture', 'Components VS Objects', 'Code Example', 'Phases', 'Phases Diagram', 'Phases Table', 'Objections Management', 'Objections Management', 'What is TLM and How to Use It', 'Types of TLM with Figure and Code', 'What is Factory', 'What is cocotb?', 'How PyUVM Uses cocotb', 'Open-Source Simulation Tools', 'The Complete Open-Source Verification Stack', 'PyUVM Code Example', 'How to Extend This Example', 'Summary']
    }),
    t.focusCardsSlide({
      index: 3,
    ...
    t.tlmOverviewSlide({
      index: 17, tag: 'Communication', title: 'What is <span class="tone-rose">TLM</span> and How to Use It',
    ...
    t.tlmTypesSlide({
      index: 18, tag: 'Communication Patterns', title: 'Types of <span class="tone-rose">TLM</span> with Figure and Code',
    ...
    t.conceptSplitSlide({
      index: 19, tag: 'Customization', title: 'What is the <span class="tone-amber">Factory</span>?',
