(function () {
  ...
  const componentsVsObjectsContent = [
    ...
    '    <h3 class="components-objects-heading components-objects-heading--components click-reveal-item">Components :</h3>',
    '    <ul class="components-objects-list">',
    '      <li class="components-objects-point pyuvm-point click-reveal-item"><span class="checkbox-wrapper-12" aria-hidden="true"><span class="cbx"><span class="cbx-circle"></span><span class="cbx-burst"></span><svg viewBox="0 0 15 12" fill="none"><path d="M1 7L5.2 11L14 1"></path></svg></span></span><span class="pyuvm-point-text">Used to build the test bench structure</span></li>',
    '      <li class="components-objects-point pyuvm-point click-reveal-item"><span class="checkbox-wrapper-12" aria-hidden="true"><span class="cbx"><span class="cbx-circle"></span><span class="cbx-burst"></span><svg viewBox="0 0 15 12" fill="none"><path d="M1 7L5.2 11L14 1"></path></svg></span></span><span class="pyuvm-point-text">Model TB hierarchy</span></li>',
    '      <li class="components-objects-point pyuvm-point click-reveal-item"><span class="checkbox-wrapper-12" aria-hidden="true"><span class="cbx"><span class="cbx-circle"></span><span class="cbx-burst"></span><svg viewBox="0 0 15 12" fill="none"><path d="M1 7L5.2 11L14 1"></path></svg></span></span><span class="pyuvm-point-text">Static-like (Quasi-Static) structures created during run time and persistent throughout simulation</span></li>',
    '    </ul>',
    '  </section>',
    '  <section class="components-objects-panel components-objects-panel--objects">',
    '    <h3 class="components-objects-heading components-objects-heading--objects click-reveal-item">Objects:</h3>',
    '    <ul class="components-objects-list">',
    '      <li class="components-objects-point pyuvm-point click-reveal-item"><span class="checkbox-wrapper-12" aria-hidden="true"><span class="cbx"><span class="cbx-circle"></span><span class="cbx-burst"></span><svg viewBox="0 0 15 12" fill="none"><path d="M1 7L5.2 11L14 1"></path></svg></span></span><span class="pyuvm-point-text">Used for stimulus modeling (transactions)</span></li>',
    '      <li class="components-objects-point pyuvm-point click-reveal-item"><span class="checkbox-wrapper-12" aria-hidden="true"><span class="cbx"><span class="cbx-circle"></span><span class="cbx-burst"></span><svg viewBox="0 0 15 12" fill="none"><path d="M1 7L5.2 11L14 1"></path></svg></span></span><span class="pyuvm-point-text">No hierarchy</span></li>',
    '      <li class="components-objects-point pyuvm-point click-reveal-item"><span class="checkbox-wrapper-12" aria-hidden="true"><span class="cbx"><span class="cbx-circle"></span><span class="cbx-burst"></span><svg viewBox="0 0 15 12" fill="none"><path d="M1 7L5.2 11L14 1"></path></svg></span></span><span class="pyuvm-point-text">Created when required during simulation, then discarded after use</span></li>',
    '    </ul>',
    '  </section>',
    '</div>'
  ].join('');
  ...
  const slides = [
    ...
    t.conceptSplitSlide({
      index: 19, tag: 'Interface Layer', title: 'What is <span class="tone-cyan">cocotb</span>?',
